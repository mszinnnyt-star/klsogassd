...
Frame.Size = UDim2.new(0, 220, 0, 400) -- Altura reduzida já que tiramos o sistema de horas
...
-- Slider de FOV
createSlider("Raio FOV", UDim2.new(0.06, 0, 0.45, 0), UDim2.new(0.06, 0, 0.51, 0), 30, 500, FOV_RADIUS, "", function(val)
    FOV_RADIUS = math.floor(val)
end)

-- Slider de Distância ESP
createSlider("Distância ESP", UDim2.new(0.06, 0, 0.60, 0), UDim2.new(0.06, 0, 0.66, 0), 100, 5000, MAX_ESP_DISTANCE, "m", function(val)
