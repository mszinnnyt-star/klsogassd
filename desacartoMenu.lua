...
Frame.Size = UDim2.new(0, 220, 0, 460) -- Altura ajustada sem o sistema de velocidade
...
-- Criador de Sliders (Sem velocidade)
...
-- Slider de Horário (Posições ajustadas para cima)
...
UserInputService.InputBegan:Connect(function(input, gameProcessed)
    ...
    -- Abre/fecha o menu com o Shift Esquerdo após autenticar a key
